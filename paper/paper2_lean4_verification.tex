...
\begin{abstract}
We present a Lean~4 / Mathlib formalization library containing 1,015 theorem
and lemma declarations, 56 definitions, spanning 66 files, with
...
producing 1,077 declarations (1,015 theorems and lemmas, 56 definitions, 6 private lemmas)
...
The library consists of 64 Lean~4 source files organized into two layers:
a set of 22 \emph{named modules} covering distinct mathematical topics,
...
\texttt{Registry.lean} is a master import file that imports all 63 other
modules.  Building it with
\begin{center}
\texttt{lake build}
\end{center}
in Lean~4~v4.14.0 with Mathlib~v4.14.0 as the sole dependency compiles all
1,077 declarations with zero errors and zero \texttt{sorry} placeholders.
...
All 1,077 declarations are discharged by three complementary
\emph{hammers}.
...
The library---1,077 declarations, 66 files, zero \texttt{sorry}---covers
